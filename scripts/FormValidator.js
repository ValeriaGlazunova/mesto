 export class FormValidator {
  ...
  _hideInputError(
    ...
    errorElement.textContent = "";
      ...
      _setEventListeners () {
        const inputList = Array.from(this._form.querySelectorAll(this._objectSettings.inputSelector));
        const buttonElement = this._form.querySelector(this._objectSettings.submitButtonSelector);
